...
function listProducts() {
    ...
    fetch("http://localhost:80/examen-final/store-examen-final-main/backend/listProducts.php")
    // --
...
function order(){
    ...
    fetch('http://localhost:80/examen-final/store-examen-final-main/backend/order.php', {method:'post', body:jsonOrder})
